...
namespace SurfaceCharts
{
    public class ChartStyle
    {
        ...
        private Font tickFont = new Font("Times New Roman", 8,  FontStyle.Regular);
        private Color tickColor = Color.Black;
        private string title = "My 3D Chart";
        private Font titleFont = new Font("Times New Roman", 14, FontStyle.Regular);
        ...
        public ChartStyle(SurfaceChartForm fm1)
        {
            form1 = fm1;
            ...
            if (IsXGrid)
            {
                ...
                if (IsYGrid)
                {
                    for (float y = YMin; y <= YMax; y = y + YTick)
                    {
                        ...
                        g.DrawLine(aPen, pta[0].X, pta[0].Y,
                        pta[1].X, pta[1].Y);
                        g.DrawLine(aPen, pta[1].X, pta[1].Y,
                        pta[2].X, pta[2].Y);
                    }
                }
                // Draw Z gridlines:
        ...
        private void AddLabels(Graphics g)
        {
            ...
            for (float y = YMin + yTick; y < YMax; y = y + YTick)
            {
                ...
                pt = new Point3(pts[1].X + labelSpace, y, pts[1].Z, pts[1].W); pt.Transform(m, form1, this);
            ...
            if (Title != "No Title")
            {
                ...
                new PointF(form1.PlotPanel.Width / 2,
                form1.Height / 30), sf);
            }
            aBrush.Dispose();
            // Add x axis label:
            ...
            pts[1].Y + labelSpace, pts[1].Z, pts[1].W); pta[0].Transform(m, form1, this);
            ...
            pta[0] = new Point3(pts[1].X + labelSpace,
            YMin, pts[1].Z, pts[1].W);
